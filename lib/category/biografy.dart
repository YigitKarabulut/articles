...
class CatBiyografi extends StatefulWidget {
  const CatBiyografi({key}) : super(key: key);

  @override
  _CatBiyografiState createState() => _CatBiyografiState();
}

class _CatBiyografiState extends State<CatBiyografi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db
            .collection("newNews")
            .where("kategori", isEqualTo: "Biyografi")
