...
class CatPsikoloji extends StatefulWidget {
  const CatPsikoloji({key}) : super(key: key);

  @override
  _CatPsikolojiState createState() => _CatPsikolojiState();
}

class _CatPsikolojiState extends State<CatPsikoloji> {
