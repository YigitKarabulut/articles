import 'package:articles/content.dart';
import 'package:articles/database.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class CatAstronomi extends StatefulWidget {
  const CatAstronomi({key}) : super(key: key);

  @override
  _CatAstronomiState createState() => _CatAstronomiState();
}

class _CatAstronomiState extends State<CatAstronomi> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: db
            .collection("newNews")
            .where("kategori", isEqualTo: "Astronomi")
        ...
        builder: (context, snapshot) {
          ...
          List<dynamic> database = snapshot.data!.docs
