...
class CatTarih extends StatefulWidget {
  const CatTarih({key}) : super(key: key);

  @override
  _CatTarihState createState() => _CatTarihState();
}

class _CatTarihState extends State<CatTarih> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot>(
        stream: db
            .collection("newNews")
            .where("kategori", isEqualTo: "Tarih")
