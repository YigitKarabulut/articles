...
class CatScience extends StatefulWidget {
  const CatScience({key}) : super(key: key);

  @override
  _CatScienceState createState() => _CatScienceState();
}

class _CatScienceState extends State<CatScience> {
