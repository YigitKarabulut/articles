...
class CatTekno extends StatefulWidget {
  const CatTekno({key}) : super(key: key);

  @override
  _CatTeknoState createState() => _CatTeknoState();
}

class _CatTeknoState extends State<CatTekno> {
